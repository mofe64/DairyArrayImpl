...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            int sentinel = 1;
            int userInput;
//        System.out.print("Enter your password to continue or press Q to exit ");
//        String userPassword = input.nextLine();
//        System.out.println("Password is " + userPassword);
//        System.out.println("Actual password is " + user.getPassword());
...
//        int exitValue = 0;
            ...
            if (authenticated != true) {
                JOptionPane.showMessageDialog(null, "Incorrect Password, do you wish to try your password again or exit ");
            } else {
                ...
                while (sentinel != -1) {
                    userInput = Integer.parseInt(JOptionPane.showInputDialog("1. press 1 to create a new Entry \n" +
                            ...
                            "3. press 3 to get a specific diary entry \n" +
